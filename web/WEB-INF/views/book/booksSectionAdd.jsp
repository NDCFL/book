        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>新增小说章节<a onClick="javascript :history.back(-1);">(双击选项卡返回到列表)</a></h5>
                </div>
                <div class="ibox-content">
                    <form method="get" class="form-horizontal" id="addform">
                        <input type="hidden" name="booksId" id="booksId" value="${booksId}" />
                        ...
                        <div class="form-group">
                            <label class="col-sm-1 control-label">章节内容</label>
                            <div class="col-sm-11">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-1">
                                <button class="btn btn-primary" type="button" id="butAdd">保存内容</button>
...
<script type="text/javascript" charset="utf-8" src="<%=path%>/static/js/pageJs/boosSectionAdd.js"></script>
<script>
