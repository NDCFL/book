            ...
            <form class="form-horizontal" method="post" id="formadd">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">小说模块名称：</label>
                        <div class="col-sm-8">
                            <input  name="name" id="bookName" minlength="2" maxlength="20" type="text" class="form-control" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">小说模块级别：</label>
                        <div class="col-sm-8">
                            <input type="number"  name="levels" id="leve" class="form-control" required="" aria-required="true"></input>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" id="update_status">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">小说模块状态：</label>
                        <div class="col-sm-8">
            ...
            <form class="form-horizontal" id="updateform" >
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">小说模块级别：</label>
                            <div class="col-sm-8">
                                <input  name="levels" class="form-control" id="levels" required="" value="" aria-required="true"></input>
                            </div>
                        </div>
                </div>
                <div class="modal-footer">
...
<script src="<%=path%>/static/js/pageJs/bookModule.js"></script>
</body>
<%--<script>--%>
    <%--$(function () {--%>
        <%--alert("asdflsfa");--%>
