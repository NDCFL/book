...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="<%=path%>/hotel/hotelListPage">充值记录</a>
                            </li>
                        </ul>
                    </li>
                <li>
                    <a href="/shop/shopPage" class="J_menuItem"><i class="fa fa-edit"></i> <span class="nav-label">商品信息</span><span class="fa arrow"></span></a>
                </li>
                    <li>
                        <a href="#"><i class="fa fa-desktop"></i> <span class="nav-label">权限管理 </span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="/employee/employeeListPage">员工管理</a>
                            </li>
                            <li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="footer">
            <div class="pull-right">&copy; 2017-2018 <a href="http://www.zi-han.net/" target="_blank">点兔阅读</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
