            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body form-group" style="margin-bottom:0px;">
                    <div class="form-group">
                        <label class="col-sm-1 control-label" style="margin-top: 5px">小说图书</label>
                        <div class="col-sm-2">
                            <select class="form-control" name="booksId" id="booksId" onchange="getList(this.value);">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="post" id="update_status">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">小说评论状态：</label>
                        <div class="col-sm-8">
...
<script src="<%=path%>/static/js/pageJs/booksDiscuss.js"></script>
</body>
<%--<script>--%>
    <%--$(function () {--%>
        <%--alert("asdflsfa");--%>
    ...
    $(function () {
        $.post(
            ...
            function (data) {
                ...
                $("#select2-booksId-container").remove();
            },
            "json"
        );
    });
