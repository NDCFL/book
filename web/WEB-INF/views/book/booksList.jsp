            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <button type="button" class="btn btn-primary" data-dismiss="modal">
                        <a class="J_menuItem"  href="/books/booksAddPage" style="color: white">新增小说</a>
                    </button>
                </div>
                <div class="panel-body form-group" style="margin-bottom:0px;">
                    ...
                    <div id="toolbar" class="btn-group pull-right" style="margin-right: 20px;">
                        ...
                        <button id="btn_add" type="button" class="btn btn-default" >
                            <a class="glyphicon glyphicon-plus" class="J_menuItem"  href="/books/booksAddPage" aria-hidden="true" style="color: white">新增</a>
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="updateform" >
                <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">小说说明：</label>
                            <div class="col-sm-8">
...
<script src="<%=path%>/static/js/pageJs/books.js"></script>
</body>
<%--<script>--%>
    <%--$(function () {--%>
        <%--alert("asdflsfa");--%>
