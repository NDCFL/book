...
<head>
    ...
    <!-- Gritter -->
    <link href="<%=path%>/static/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<script src="<%=path%>/static/js/plugins/flot/jquery.flot.spline.js"></script>
<script src="<%=path%>/static/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="<%=path%>/static/js/plugins/flot/jquery.flot.pie.js"></script>
...
<script src="<%=path%>/static/js/plugins/jquery-ui/jquery-ui.min.js"></script>
<script src="<%=path%>/static/js/plugins/gritter/jquery.gritter.min.js"></script>
<script src="<%=path%>/static/js/plugins/easypiechart/jquery.easypiechart.js"></script>
<script src="<%=path%>/static/js/plugins/sparkline/jquery.sparkline.min.js"></script>
<script src="<%=path%>/static/js/demo/sparkline-demo.min.js"></script>
<script>
